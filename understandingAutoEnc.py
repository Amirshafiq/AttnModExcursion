# -*- coding: utf-8 -*-
"""
Created on Thu Jan  4 19:33:51 2018
...
with tf.name_scope('en-convolutions'):
    convn1 = tf.layers.conv2d(inputs_,filters=32,kernel_size=(3,3),strides=(1,1),padding='SAME',use_bias=True,activation=lrelu,name='convn1')
# Now 28x28x32
with tf.name_scope('en-pooling'):
    maxpool1 = tf.layers.max_pooling2d(convn1,pool_size=(2,2),strides=(2,2),name='pool1')
# Now 14x14x32
with tf.name_scope('en-convolutions'):
    convn2 = tf.layers.conv2d(maxpool1,filters=32,kernel_size=(3,3),strides=(1,1),padding='SAME',use_bias=True,activation=lrelu,name='convn2')
# Now 14x14x32
with tf.name_scope('encoding'):
    encoded = tf.layers.max_pooling2d(convn2,pool_size=(2,2),strides=(2,2),name='encoding')
# Now 7x7x32.
#latent space
...
for e in range(epochs):
    ...
    plt.figure()
    plt.show()
    saver.save(sess, 'D:\Amir\Dropbox (GhassanGT)\Amir\Big_and_Data\Code\Autoencoders\Autoencoders\encode_model\encode_model') 
